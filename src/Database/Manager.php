...
class Manager
{
     ...
     *
     * @var \Jdikasa\Etl\Database\ConnectionFactory
     */
    protected $factory;
     ...
     *
     * @param  \Jdikasa\Etl\Database\ConnectionFactory  $factory
     * @return void
     */
     ...
     *
     * @param  string  $name
     * @return \Jdikasa\Etl\Database\Connection
     */
     ...
     * @return \Jdikasa\Etl\Database\Query
     */
     ...
     *
     * @param  string  $connection
     * @return \Jdikasa\Etl\Database\Statement
     */
     ...
     *
     * @param  string  $connection
     * @return \Jdikasa\Etl\Database\Transaction
     */
